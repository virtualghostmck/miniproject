...
namespace PresentationLayer.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        readonly UserService userServices = new UserService();
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    if (user.Roles.First().RoleId.Equals("dfd1482d-c60a-4aed-ac21-334eabb72276"))
                    {
                        return RedirectToAction("Details", "AdminHimself", new { Area = "Admin" });
                    }
        ...
        public ActionResult Register()
        {
            ...
            // ViewBag.Name = new SelectList(context.City.ToList(), "CityID", "CityName");
        ...
        public async Task<ActionResult> Register(RegViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.CustomerName, Email = model.Email };
                var result = await UserManager.CreateAsync(user, model.Password);
